(ns notify-blaster.controllers.groups
  (:require
   [notify-blaster.models.group :as model]
   [notify-blaster.models.contact :as contact]
   [notify-blaster.views.groups :as view]
   [ring.util.response :as res]
   [cemerick.friend :as friend]
   [cemerick.friend.workflows :as workflows]
   [notify-blaster.models.validation.group :as group-rules])
  (:use
