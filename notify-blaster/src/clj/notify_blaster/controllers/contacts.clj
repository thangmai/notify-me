(ns notify-blaster.controllers.contacts
  (:require
   [notify-blaster.models.contact :as model]
   [notify-blaster.views.contacts :as view]
   [ring.util.response :as res]
   [cemerick.friend :as friend]
   [cemerick.friend.workflows :as workflows]
   [notify-blaster.models.validation.contact :as contact-rules])
  (:use
